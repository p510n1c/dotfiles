local function get_jdtls()
  local launcher =
    vim.fn.glob("/home/sergiu/.local/share/nvim/mason/packages/jdtls" .. "/plugins/org.eclipse.equinox.launcher_*.jar")
  -- Declare white operating system we are using, windows use win, macos use mac
  local SYSTEM = "linux"
  -- Obtain the path to configuration files for your specific operating system
  local config = "/home/sergiu/.local/share/nvim/mason/packages/jdtls" .. "/config_" .. SYSTEM
  -- Obtain the path to the Lomboc jar
  local lombok = "/home/sergiu/.local/share/java/lombok.jar"
...
local function get_bundles()
  local bundles = {
    vim.fn.glob(
      "/home/sergiu/.local/share/nvim/mason/packages/java-debug-adapter"
  ...
  vim.list_extend(
    bundles,
    vim.split(
      vim.fn.glob("home/sergiu/.local/share/nvim/mason/packages/java-test" .. "/extension/server/*.jar", 1),
      "\n"
    )
  )
...
local function get_workspace()
  local workspace_path = "/home/sergiu/.code/workspace/"
...
local function setup_jdtls()
  ...
  -- Start with base LSP capabilities and merge with nvim-cmp capabilities
  local capabilities = vim.lsp.protocol.make_client_capabilities()
  capabilities = require("cmp_nvim_lsp").default_capabilities(capabilities)

  -- IMPORTANT: cmp_nvim_lsp.default_capabilities() removes the workspace table,
  -- so we need to add it back from the base capabilities
  ...
  local settings = {
    java = {
      ...
      format = {
        ...
        settings = {
          url = "/home/sergiu/.local/share/java/format/intellij-java-google-style.xml",
          profile = "GoogleStyle",
        },
      },
